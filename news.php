      ...
      <div class="container">
        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 gy-5 gx-md-5 gy-lg-0 gx-lg-5 mt-0">
          ...
          foreach ($featured_news as $news) {
            ...
            <div class="col">
              <a href="<?php echo $news['news_url']; ?>" class="comon-blogs1">
                <figure>
                ...
                <div class="news-items-del">
                  ...
                  <p class="mt-2" style="text-align: justify !important;"> <?php echo $news['short_higlight']; ?>.</p>
          ...
          <div class="col">
            <a href="https://bsnsports.com.ng/post/Yoshi-Dubai-Abuja-Primary--Secondary-Schools-Football-Tournament-Kicks-off-September-14"
              class="comon-blogs1">
              <figure>
                <img src="images/YAPS_2024_KICKOFF.jpg" alt="bn" />
                <figcaption>
                  <b class="d-block">12</b>
                  Sep
                </figcaption>
              </figure>
              <div class="news-items-del">
                <h5> Yoshi-Dubai-Abuja Primary, Secondary Schools Football Tournament Kicks off September 14</h5>
                <ul class="list-unstyled d-flex align-items-center my-2">
                  <li>
                    <i class="far fa-user"></i> Abubakar
                  </li>
                ...
                <p class="mt-2" style="text-align: justify !important;"> Yoshi-Dubai-Abuja football tournament for
                  Primary, Junior Secondary and Senior Secondary schools will kick off on 14th September, 2024 at the
                  Astro Turf, Accra street, Wuse Zone 5, Abuja.
                </p>
