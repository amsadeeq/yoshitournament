...
<html lang="en">
  ...
  <head>
    ...
    <title>News - Yoshi Tournament </title>
...
<section class="sub-main-banner float-start w-100">
            ...
            <div class="sub-banner">
                <div class="container">
                        ...
                        <h1 class="text-center"> Yoshi Tournament News </h1> 
                    ...
                    <div class="col">
                        <a href="news-details.html" class="comon-blogs1">
                            ...
                            <div class="news-items-del">
                                ...
                                <h6 class="btn reda-btn mt-3"> Read more <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-up-right-square" viewBox="0 0 16 16">
