                                    ...
                                    <div class="ad-fm ">
                                        <div class="comon-steps-div">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <fieldset>
                                                            ...
                                                            <p style="font-size: 12px;">[ Note:<sup
                                                                    style="color: red !important;">*</sup> Image size:
                                                                300KB, jpg, jpeg, png ] </p>
                                                            <img style="height:50%; width: 50%;" class="my-select"
                                                                id="image">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label> Surname<sup style="color: red !important;">*</sup>
                                                        </label> </label>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label> First Name<sup style="color: red !important;">*</sup>
                                                        </label> </label>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label> Gender<sup style="color: red !important;">*</sup>
                                                        </label> </label>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label> Date of Birth<sup style="color: red !important;">*</sup>
                                                        </label> </label>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label>Country<sup style="color: red !important;">*</sup>
                                                        </label></label>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label> Town / City<sup style="color: red !important;">*</sup>
                                                        </label> </label>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label> Phone Number<sup style="color: red !important;">*</sup>
                                                        </label> </label>
                                                        <input type="tel" id="phone" name="phone"
                                                            name="player_phone_number" class="form-control"
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label> Email<sup style="color: red !important;">*</sup>
                                                        </label> </label>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label> Address 1<sup style="color: red !important;">*</sup>
                                                        </label> </label>
