...
<head>
  ...
  <title>Soccer club - Wishlist </title>
...
<body>
  ...
  <section class="body-part-total float-start w-100">
    ...
    <div class="mmy-wishlist-pages my-5">
      <div class="container">
        <h2 class="comon-heading m-0"> My Wishlist </h2>
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 gy-5 gx-md-5 gy-lg-5 gx-lg-5 mt-0">
          <div class="col">
            <div class="comon-whistlist">
              <a href="products-details.html" class="pro-img">
                <figure>
                  <img src="images/shoes.jpg" alt="wist" />
                </figure>
              </a>
              <div class="whilist-details">
                <h6> Shoes </h6>
                <a href="#" class="titel-shoes"> Stylist sports Shoes </a>
                <h4> $50.00</h4>
                <a href="cart.html" class="btn cart-btn"> Add to Cart
                ...
                <div class="d-block">
                  <a href="#" class="remov mt-2"> remove </a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col">
            <div class="comon-whistlist">
              <a href="products-details.html" class="pro-img">
                <figure>
                  <img src="images/product03.jpg" alt="wist" />
                </figure>
              </a>
              <div class="whilist-details">
                <h6> Shirt </h6>
                <a href="#" class="titel-shoes"> Stylist sports Shirt </a>
                <h4> $50.00</h4>
                <a href="cart.html" class="btn cart-btn"> Add to Cart
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart3"
                    viewBox="0 0 16 16">
          ...
          <div class="col">
            <div class="comon-whistlist">
              <a href="products-details.html" class="pro-img">
                <figure>
                  <img src="images/product-13-copyright-393x426.webp" alt="wist" />
                </figure>
              </a>
              <div class="whilist-details">
                <h6> Gloves </h6>
                <a href="#" class="titel-shoes"> sports gloves </a>
                <h4> $50.00</h4>
                <a href="cart.html" class="btn cart-btn"> Add to Cart
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart3"
                    viewBox="0 0 16 16">
          ...
          <div class="col">
            <div class="comon-whistlist">
              <a href="products-details.html" class="pro-img">
                <figure>
                  <img src="images/product02.webp" alt="wist" />
                </figure>
              </a>
              <div class="whilist-details">
                <h6> Shoes </h6>
          ...
          <div class="col">
            <div class="comon-whistlist">
              <a href="products-details.html" class="pro-img">
                <figure>
                  <img src="images/s3.jpg" alt="wist" />
                </figure>
              </a>
              <div class="whilist-details">
                <h6> Shoes </h6>
          ...
          <div class="col">
            <div class="comon-whistlist">
              <a href="products-details.html" class="pro-img">
                <figure>
                  <img src="images/product01.jpg" alt="wist" />
                </figure>
              </a>
              <div class="whilist-details">
                <h6> Shirt </h6>
          ...
          <div class="col">
            <div class="comon-whistlist">
              <a href="products-details.html" class="pro-img">
                <figure>
                  <img src="images/shoes1.webp" alt="wist" />
                </figure>
              </a>
              <div class="whilist-details">
                <h6> Shoes </h6>
