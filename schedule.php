                ...
                <div class="table-div-left mt-4">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>Abuja Stadium</td>
                            <td>
                                <a href="booking.html" class="btn details-btn"> buy ticket  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-up-right-square-fill" viewBox="0 0 16 16">
                        ...
                        <tr>
                            ...
                            <td>Abuja Stadium</td>
                            <td>
                                <a data-bs-toggle="modal" data-bs-target="#bookModal" class="btn details-btn"> buy ticket  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-up-right-square-fill" viewBox="0 0 16 16">
                                    <path d="M14 0a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h12zM5.904 10.803 10 6.707v2.768a.5.5 0 0 0 1 0V5.5a.5.5 0 0 0-.5-.5H6.525a.5.5 0 1 0 0 1h2.768l-4.096 4.096a.5.5 0 0 0 .707.707z"></path>
                                  </svg> </a>
                            </td>
                        </tr>
       ...
       <div class="row row-cols-1 row-cols-lg-3">
           ...
           <div class="col">
              <div class="comon-footer">
                  ...
                  <div class="d-flex mt-3 align-items-center input-group mt-3">
                    <input type="email" class="form-control" placeholder="Enter Email" aria-label="Enter Email" aria-describedby="basic-addon2">
                    <div class="input-group-append">
                      <button class="btn scub-btn" type="button">
