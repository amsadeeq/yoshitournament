                  ...
                  <div class="modal-content confirm_modal text-center">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="fa-3x">
                        ...
                        <i class="fa-solid fa-envelope fa-bounce"
                          style="--fa-bounce-start-scale-x: 1;--fa-bounce-start-scale-y: 1;--fa-bounce-jump-scale-x: 1;--fa-bounce-jump-scale-y: 1;--fa-bounce-land-scale-x: 1;--fa-bounce-land-scale-y: 1;--fa-bounce-rebound: 0;color:green;"></i>
                      </div>
                    ...
                    <div class="modal-footer">
                      <span>Didn't recieved the link yet ? </span><a href="#"
                        class="btn btn-success btn-border-radius">Resend Link</a>
                    </div>
                  </div>
                </div>
              </div>
