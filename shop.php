      ...
      <div class="container">
        <div class="row g-lg-5">
          <div class="col-lg-4">
            ...
            <div class="accordion mt-0 list-serach-acd" id="accordionPanelsStayOpenExample">
          ...
          <div class="col-lg-8">
              ...
              <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="listed-bn">
                  <ul class="list-unstyled d-flex align-items-center justify-content-end">
                    <li>
                      <a id="list" class="active"> <i class="fas fa-th-list"></i> </a>
                    </li>
                    <li>
                      <a id="grid"> <i class="fas fa-th-large"></i> </a>
                    </li>
                  </ul>
                </div>
                <p class="ms-4"> Showing 1-4 of 13 results </p>
            ...
            <div id="products" class="mt-4">
              <div class="row justify-content-between">
                <div class="item list-item col-md-2 col-lg-6 view-group list-group-item collist">
                  <div class="comon-items-d1">

                    <a href="products-details.php" class="left-div-list">
                      <figure class="mb-0">
                        <img src="images/product02.webp" alt="sm">
                    ...
                    <div class="right-list-div">
                      <div class="d-flex mb-1 justify-content-between align-items-center">
                        <h6 class="locations-ts">
                          <i class="fas fa-map-marker-alt"></i> shoes
                        </h6>

                      </div>
                      <a href="products-details.php" class="titel-product"> Donec quis felis eu massa iaculis auctor
                        et non nulla </a>
                      ...
                      <div class="d-flex align-items-center justify-content-between">
                        <button type="button" class="btn view-products mt-0"> Add To Cart
                        ...
                        <ul class="list-unstyled m-0">
                          <li>
                            <a class="btn comon-likke fv-list-n" data-bs-toggle="tooltip" data--bs-placement="top"
                ...
                <div class="item list-item col-md-2 col-lg-6 view-group list-group-item collist">
                  <div class="comon-items-d1">
                    ...
                    <a href="products-details.php" class="left-div-list">
                      <figure class="mb-0">
                        <img src="images/product-13-copyright-393x426.webp" alt="sm">
                        <span class="btn-sm strat-r "> 4.5 <i class="fas fa-star"></i> </span>
                      </figure>
                    </a>
                    ...
                    <div class="right-list-div">
                      <div class="d-flex mb-1 justify-content-between align-items-center">
                        <h6 class="locations-ts">
                          <i class="fas fa-map-marker-alt"></i> Gloves
                        </h6>
                ...
                <div class="item list-item col-md-2 col-lg-6 view-group list-group-item collist">
                  <div class="comon-items-d1">
                    ...
                    <a href="products-details.php" class="left-div-list">
                      <figure class="mb-0">
                        <img src="images/product01.jpg" alt="sm">
                        <span class="btn-sm strat-r "> 4.5 <i class="fas fa-star"></i> </span>
                      </figure>
                    </a>
                    ...
                    <div class="right-list-div">
                      <div class="d-flex mb-1 justify-content-between align-items-center">
                        <h6 class="locations-ts">
                          <i class="fas fa-map-marker-alt"></i> T-shirt
                        </h6>
                ...
                <div class="item list-item col-md-2 col-lg-6 view-group list-group-item collist">
                  <div class="comon-items-d1">
                    ...
                    <a href="products-details.php" class="left-div-list">
                      <figure class="mb-0">
                        <img src="images/product03.jpg" alt="sm">
                        <span class="btn-sm strat-r "> 4.5 <i class="fas fa-star"></i> </span>
                      </figure>
                    </a>
