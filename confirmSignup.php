...
<body>
  ...
  <section class="sub-main-banner float-start w-100">
    ...
    <div class="sub-banner">
      <div class="container">
        <h1 class="text-center"> Account Successfully Created </h1>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content confirm_modal text-center">
                    ...
                    <div class="modal-body">
                      ...
                      <h3 class="mt-4">Pending Signup</h3>
                      <p class="lead text-dark">We have sent you activation link to your email. Kindly check and
