...
<head>
  ...
  <title>Soccer club - Booking </title>
                ...
                <div class="col-lg-8">
                  <div class="ad-fm ">
                    <div class="comon-steps-div">
                      <h2 class="comon-heading m-0"> Booking Details</h2>
                      <div class="row mt-4">
                        <div class="col-lg-6">
                ...
                <div class="col-lg-4">
                  <div class="ceck-out-right-div new-checkout">
                    <div class="d-flex justify-content-between align-items-center">
                      <h2 class="page-titel comon-heading m-0"> Booking Payment </h2>
                    ...
                    <div class="oder-summary-item">
                      ...
                      <div class="ad-booking d-flex align-content-center justify-content-between">
                        <h6 class="m-0"> 2 Adults </h6>
                        <span> $120</span>
                      </div>
                      <div class="ad-booking mt-3 d-flex align-content-center justify-content-between">
                        <h6 class="m-0"> 1 Child </h6>
                        <span> $20</span>
                      </div>

                      <div class="form-group d-flex align-items-center">
                        <input type="text" class="form-control new-input ps-3" placeholder="Discount Coupon ">
                    ...
                    <div class="oder-right-details-new">
                      ...
                      <div class="price-sec-order">
                        ...
                        <div class="total-price p-0">
                          <p class="discount-am mb-lg-0"> Total Amount <span> $ 140 </span></p>
                        </div>
                  ...
                  <a href="javascript:;" class="form-wizard-next-btn w-100 text-center float-right mt-2">Proceed to
                    Pay</a>
