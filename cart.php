...
<body>
  ...
  <section class="body-part-total float-start w-100">
    ...
    <div class="cart-main-div-total my-5">
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-8 col-lg-9">
              <div class="ceck-out-right-div">
                <div class="d-flex justify-content-between align-items-center">
                  <h2 class="comon-heading m-0"> Order Summary </h2>
                  ...
                  <div class="form-new">
                    ...
                    <div class="comon-order-items">
                      <div class="items-details">
                        ...
                        <div class="row row-cols-1 g-lg-5 row-cols-lg-2 justify-content-between align-items-center">
                          <div class="col">
                            <div class="d-flex justify-content-between align-items-center">
                              <a href="products-details.html" class="pro-img">
                                <figure class="m-0">
                                  <img src="images/product02.webp" alt="bn" />
                                </figure>
                              </a>

                              <a href="#" class="cart-products-titel"> Shoes Black </a>


                              <div class="form-group">

                                <select class="form-select " aria-label="Default select example">
                                  <option selected>10cm</option>
                                  <option value="1">20cm</option>
                                  <option value="2">35cm</option>
                          ...
                          <div class="col">
                            <div class="d-flex justify-content-between align-items-center">
                              ...
                              <div class="form-group">
                                ...
                                <div class="quantity-control" data-quantity="">
                                  ...
                                  <input type="number" class="quantity-input" data-quantity-target="" value="1"
                                    step="0.1" min="1" max="" name="quantity">
                              ...
                              <div class="items-price mt-lg-3">
                                <h2>$ 30</h2>
                              </div>
                              <button type="button" class="btn close-bn-ps">
                        ...
                        <div class="row row-cols-1 g-lg-5 row-cols-lg-2 justify-content-between align-items-center">
                          <div class="col">
                            <div class="d-flex justify-content-between align-items-center">
                              <a href="products-details.html" class="pro-img">
                                <figure class="m-0">
                                  <img src="images/s1.jpg" alt="bn" />
                                </figure>
                              </a>

                              <a href="#" class="cart-products-titel"> Sport Shoes </a>
                        ...
                        <div class="row row-cols-1 g-lg-5 row-cols-lg-2 justify-content-between align-items-center">
                          <div class="col">
                            <div class="d-flex justify-content-between align-items-center">
                              <a href="products-details.html" class="pro-img">
                                <figure class="m-0">
                                  <img src="images/product01.jpg" alt="bn" />
                                </figure>
                              </a>

                              <a href="#" class="cart-products-titel"> Dark T-shirt </a>
            ...
            <div class="col-md-4 col-lg-3">
              ...
              <div class="oder-right-details">
                <h2 class="comon-heading m-0"> Order Details </h2>
                <hr />
                <div class="price-sec-order">
                  <p class="price-am"> Price <span> $250 </span></p>
                  <p class="delivery-am"> Delivery charges <span> Free </span></p>
                  <p class="discount-am"> Discount price <span> $ 10 </span></p>
                  <div class="form-group d-flex align-items-center">
                    <input type="text" class="form-control new-input" placeholder="Discount Coupon" />
                    <input type="submit" value="Apply" class="btn cp-bn me-0" />
                  </div>
                  <div class="total-price">
                    <p class="discount-am mb-lg-0 my-3"> Total Amount <span> $ 280 </span></p>
                  </div>
                </div>
              </div>

              <a href="checkout.html" class="btn form-wizard-next-btn checkout-bn ms-lg-auto mt-3 d-table w-100"> Place
                Order <i class="fas fa-long-arrow-alt-right"></i> </a>
