...
<head>
  ...
  <title>News details - Yoshi Tournament </title>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link btn join-btn" data-bs-toggle="modal" class="reAbujaer-bn" data-bs-target="#loginModal">
      ...
      <div class="container">
        <div class="row gx-lg-5">
          <div class="col-lg-7 col-xl-8">
            <div class="blog-post">
              <figure>
                <img src="images/Yoshi_10.jpg" alt="post" />
              </figure>
            ...
            <div class="comment-sec-part mt-4">
              ...
              <div class="comon-com-div mt-4">
                <div class="d-lg-flex justify-content-between">
                  <figure>
                    <img src="images/yoshi_founder.png" alt="user-pic" />
                  </figure>
                  <div class="comment-text">
                    <div class="d-flex align-items-center">
                      <h5 class="m-0"> Abubakar Sadiq </h5> <span class="d-inline ms-3"> Oct 24 ,2024 </span>
                    </div>

                    <p class="mt-2"> Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in
              ...
              <div class="comon-com-div mt-4">
                <div class="d-lg-flex justify-content-between">
                  ...
                  <div class="comment-text">
                    <div class="d-flex align-items-center">
                      <h5 class="m-0"> Musa Ahmed </h5> <span class="d-inline ms-3"> Dec 12 ,2024 </span>
                    </div>
          ...
          <div class="col-lg-5 col-xl-4">
            <div class="category-div">
              ...
              <ul class="list-unstyled mt-4">
                <li>
                  <a href="#"> <i class="fas fa-caret-right"></i> Yoshi 2023 Tournaments</a>
                </li>
                <li>
                  <a href="#"> <i class="fas fa-caret-right"></i> Yoshi Partner with Man United </a>
                </li>
                <li>
                  <a href="#"> <i class="fas fa-caret-right"></i> 13 Clubs disqualified</a>
                </li>
                <li>
                  <a href="#"> <i class="fas fa-caret-right"></i> Yoshi in Kenya</a>
                </li>
                <li>
                  <a href="#"> <i class="fas fa-caret-right"></i> Qatar Football and Yoshi</a>
                </li>
                <li>
                  <a href="#"> <i class="fas fa-caret-right"></i> $20 Million football contract </a>
                </li>
              </ul>
            </div>
            <div class="recent-post-div mt-5">
              ...
              <div class="recent-post-div-insiide">
                <a href="#" class="d-flex w-100 justify-content-between align-items-center">
                  ...
                  <h5> We Played we win, Yoshi. </h5>
                </a>
                <a href="#" class="d-flex w-100 justify-content-between align-items-center">
                  <figure>
                    <img src="images/bg-mc3.jpeg" alt="post" />
                  </figure>
                  <h5> Yoshi in Saudi Arabia </h5>
                </a>
                <a href="#" class="d-flex w-100 justify-content-between align-items-center">
                  <figure>
            ...
            <div class="login-modal-pn">
              ...
              <div class="cm-select-login mt-3">
                <div class="country-dp">
                  ...
                  <input type="email" class="form-control login-input" placeholder="Email" alt="pn" required>
                </div>
                <div class="phone-div">

                  <input type="password" class="form-control login-input" placeholder="Password" alt="pn" required>
                </div>


              </div>

              <button class="btn continue-bn login-input"> Sign In </button>
            </div>

            <p class="text-center  mt-3">
              <a data-bs-toggle="modal" class="reAbujaer-bn" data-bs-target="#lostpsModal" data-bs-dismiss="modal">
                Forget password ? </a>
            </p>


            <p class="text-center  mt-3"> Do not have an account yet ?
              <a data-bs-toggle="modal" class="reAbujaer-bn" data-bs-target="#registerModal" data-bs-dismiss="modal">
                Register </a>
            </p>
          </div>
        ...
        <div class="modal-body">
          <div id="login-td-div" class="com-div-md">
            ...
            <div class="login-modal-pn">
              ...
              <div class="cm-select-login mt-3">
                <!-- <div class="country-dp">
               <input type="text" class="form-control login-input" placeholder="Full Name" alt="pn">
             </div> -->
                ...
                <div class="phone-div">
                  ...
                  <input type="password" class="form-control login-input" placeholder="Confirm Password" alt="pn"
                    required>
                </div>
              ...
              <button class="btn continue-bn login-input"> Sign Up </button>
            </div>
            ...
            <p class="text-center  mt-3"> Do not have an account?
              <a data-bs-toggle="modal" class="reAbujaer-bn" data-bs-target="#loginModal" data-bs-dismiss="modal"> Login
              </a>
            </p>
          </div>
        </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div id="login-td-div" class="com-div-md">
            ...
            <h5 class="text-center mb-3 form-text"> Forget Your Password? </h5>
            <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">×</span>
            </button>
            <div class="login-modal-pn">
              ...
              <div class="cm-select-login mt-3">
                ...
                <div class="phone-div">
                  ...
                  <input type="email" class="form-control login-input" placeholder="Enter Your Email " alt="pn">
                </div>
              ...
              <button class="btn continue-bn login-input"> Send Me a password reset Link </button>
            </div>
