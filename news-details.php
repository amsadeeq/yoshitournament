      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link " href="about.html">The Clubs</a>
            </li>
      ...
      <div class="modal-body">
        ...
        <div id="login-td-div" class="com-div-md">
         ...
         <p class="text-center  mt-3">  
          <a data-bs-toggle="modal" class="reAbujaer-bn" data-bs-target="#lostpsModal" data-bs-dismiss="modal"> Forget password ? </a>  </p>
          
          
           <p class="text-center  mt-3"> Do not have an account yet ? 
             <a data-bs-toggle="modal" class="reAbujaer-bn" data-bs-target="#registerModal" data-bs-dismiss="modal"> Register </a>  </p>
        </div>
        ...
        <div id="login-td-div" class="com-div-md">
          ...
          <div class="login-modal-pn">
           ...
           <div class="cm-select-login mt-3">
             ...
             <div class="phone-div">
              ...
              <input type="password" class="form-control login-input" placeholder="Confirm Password" alt="pn" required>
            </div>
         ...
         <ul class="list-unstyled socal-linka-div d-flex  align-content-center justify-content-center">
           ...
           <p class="text-center  mt-3"> Do not have an account? 
             <a data-bs-toggle="modal" class="reAbujaer-bn" data-bs-target="#loginModal" data-bs-dismiss="modal"> Login </a>  </p>
        </div>
      </div>
