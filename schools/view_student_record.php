...
$sql = "SELECT * FROM yoshi_school_students_tbl WHERE userRefNo = :userId";
...
<div class="modal-dialog modal-lg" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title">Personal Profile</h5>
            ...
            <?php if ($record): ?>
                ...
                <div class="row">
                    <div class="col-md-3 col-6">
                        <img src="<?php echo "student_photo/" . $record['passport']; ?>"
