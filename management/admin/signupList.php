...
<head>
  ...
  <title>Accounts List | Yoshi Tournament</title>
        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                <div class="x_title">
                  <h2>List of Accounts <small>(Users)</small></h2>
                    ...
                    <div class="col-sm-12">
                      <div class="card-box table-responsive">
                        <p class="text-muted font-13 m-b-30">
                          ...
                          layout for different screen sizes through the dynamic insertion and removal of columns from
                          the table.
                        </p>
